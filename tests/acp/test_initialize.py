...
class TestACPInitialize:
    ...
    async def test_initialize(self, acp_agent_loop: VibeAcpAgentLoop) -> None:
        ...
        assert response.agent_info == Implementation(
            name="@mistralai/albert-code", title="Albert Code", version="2.3.0"
        )
    ...
    async def test_initialize_with_terminal_auth(
        ...
        assert auth_method.description == "Register your API Key inside Albert Code"
        ...
        assert terminal_auth_meta["label"] == "Albert Code Setup"
