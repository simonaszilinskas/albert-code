...
from albert_code.core.paths.config_paths import discover_local_tools_dirs
from albert_code.core.paths.global_paths import DEFAULT_TOOL_DIR, GLOBAL_TOOLS_DIR
from albert_code.core.tools.base import BaseTool, BaseToolConfig
from albert_code.core.tools.mcp import MCPRegistry
from albert_code.core.utils import name_matches
...
def _try_canonical_module_name(path: Path) -> str | None:
    ...
    try:
        vibe_idx = parts.index("albert_code")
    except ValueError:
        return None
