...
if TYPE_CHECKING:
    ...
    from albert_code.core.config import ProjectContextConfig, VibeConfig
...
def _add_commit_signature() -> str:
    return (
        ...
        "It will always be suffixed with a line telling it was generated by Albert Code with the appropriate co-authoring information.\n"
        "The format you will always uses is the following heredoc.\n\n"
        "```bash\n"
        "git commit -m <Commit message here>\n\n"
        "Generated by Albert Code.\n"
        "Co-Authored-By: Albert Code <albert-code@etalab.gouv.fr>\n"
        "```"
    )
