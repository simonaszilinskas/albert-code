...
from albert_code.cli.textual_ui.widgets.approval_app import ApprovalApp
from albert_code.cli.textual_ui.widgets.banner.banner import Banner
...
from albert_code.cli.update_notifier.update import do_update
...
from albert_code.core.utils import (
    CancellationReason,
...
"""
    ...
    def action_suspend_with_message(self) -> None:
        ...
        with self.suspend():
            rprint(
                "Albert Code has been suspended. Run [bold cyan]fg[/bold cyan] to bring Albert Code back."
            )
...
def _print_session_resume_message(session_id: str | None) -> None:
    ...
    print()
    print("To continue this session, run: albert-code --continue")
    print(f"Or: albert-code --resume {session_id}")
