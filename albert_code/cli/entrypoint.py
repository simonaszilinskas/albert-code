...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Albert Code interactive CLI")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "or custom from ~/.albert-code/agents/NAME.toml)",
    )
    ...
    parser.add_argument(
        "--api-key",
        metavar="KEY",
        help="Set the API key for the active provider and save it to ~/.albert-code/.env",
    )
...
def check_and_resolve_trusted_folder() -> None:
    try:
        ...
        rprint(
            ...
            "[yellow]The directory you started albert-code from has been deleted. "
...
def main() -> None:
    ...
    from albert_code.cli.cli import run_cli
